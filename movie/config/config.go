...
func Load() Config {
	...
	// type assertation
	config.App = cast.ToString(getOrReturnDefaultValue("PROJECT_NAME", "movie"))
	...
	config.PostgresDatabase = cast.ToString(getOrReturnDefaultValue("POSTGRES_DATABASE", "movie"))
